...
# myT.root=myT.deleteAllLeafNodes(myT.root)
# myT.deleteAllLeafNodesBFS()
# myT.breadthFirstTraversal()
# print("\nDelete node has only a left child")
# myT.root=myT.deleteAllNodesHasOnlyALeftChild(myT.root)
# myT.breadthFirstTraversal()
# print("\nDelete all node has only a right child")
# myT.root=myT.deleteAllNodesHasOnlyARightChild(myT.root)
# myT.breadthFirstTraversal()
print("\nDelete in range")
x=int(input("Input value to delete x = "))
y=int(input("Input value to delete y = "))
myT.root=myT.deleteAllNodesValueInRange(myT.root, x, y)
myT.breadthFirstTraversal()